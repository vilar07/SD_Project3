...
/**
 * Proxy Agent for the Concentration Site, inherits the attributes and methods of both Master Thief and Ordinary Thief.
 */
public class ConcentrationSiteProxyAgent extends Thread implements MasterThiefClone, OrdinaryThiefClone {
    ...
    */
    ...
    /**
     * ConcentrationSiteProxyAgent constructor.
     * @param serverCom the server communication channel.
     * @param concentrationSiteInterface the interface to the Concentration Site.
     */
    ...
    /**
     * Lifecycle of the ConcentrationSiteProxyAgent.
     */
    @Override
    public void run() {
