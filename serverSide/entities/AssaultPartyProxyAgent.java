...
/**
 * Proxy Agent for the Assault Party, inherits the attributes and methods of both Master Thief and Ordinary Thief.
 */
public class AssaultPartyProxyAgent extends Thread implements MasterThiefClone, OrdinaryThiefClone {
    ...
    */
    ...
    /**
     * AssaultPartyProxyAgent constructor.
     * @param serverCom the server communication channel.
     * @param assaultPartyInterface the interface to the Assault Party.
     */
    ...
    /**
     * Lifecycle of the AssaultPartyProxyAgent.
     */
    @Override
    public void run() {
